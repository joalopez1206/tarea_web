...
jQuery(document).ready(function () {
	...
	let iRegion = 0;
	let htmlRegion = '<option value="sin-region">Seleccione región</option><option value="sin-region">--</option>';
	let htmlComunas = '<option value="sin-region">Seleccione comuna</option><option value="sin-region">--</option>';
	...
	jQuery('#region').change(function () {
		let iRegiones = 0;
		let valorRegion = jQuery(this).val();
